  ...
  return (
    <>
      ...
      >
        ...
        >
          <div
            style={{ position: "absolute", top: "-10%", right: "-10%", width: 400, height: 400, borderRadius: "50%", background: "rgba(255,255,255,0.03)" }}
          />
          <div
            style={{ position: "absolute", bottom: "10%", left: "5%", width: 300, height: 300, borderRadius: "50%", background: "rgba(255,255,255,0.02)" }}
          />
          ...
          <div
            style={{
              ...
              marginBottom: 32, boxShadow: "0 8px 32px rgba(0,0,0,0.1)",
            }}
          >
          ...
          <Paragraph style={{ color: "rgba(255,255,255,0.85)", fontSize: 18, maxWidth: 400, textAlign: "center", lineHeight: 1.7, marginBottom: 40 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16, maxWidth: 360 }}>
            {[
              ...
              <div
                key={index}
                style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 16px", background: "rgba(255,255,255,0.08)", borderRadius: 12, backdropFilter: "blur(10px)" }}
              >
        ...
        >
          <div style={{ width: "100%", maxWidth: 400 }}>
            <div style={{ marginBottom: 32, textAlign: "center" }}>
              <Title level={2} style={{ marginBottom: 8, fontWeight: 700 }}>Xin chào!</Title>
              <Text type="secondary" style={{ fontSize: 15 }}>Đăng nhập để tiếp tục sử dụng hệ thống</Text>
            </div>

            <Card style={{ borderRadius: 16, boxShadow: "0 4px 24px rgba(0,0,0,0.06)", border: "none" }} styles={{ body: { padding: "32px 24px" } }}>
              <Form layout="vertical" onFinish={handleSubmit(onFinish)}>
                ...
                <div style={{ textAlign: "right", marginBottom: 20 }}>
                  <Link to="#" style={{ fontSize: 13, color: "#1677ff" }}>Quên mật khẩu?</Link>
                </div>
                ...
                <div style={{ textAlign: "center" }}>
                  <Text type="secondary" style={{ fontSize: 14 }}>
                    Chưa có tài khoản?{" "}
                    <Link to="/register" style={{ fontWeight: 600, color: "#1677ff" }}>Đăng ký ngay</Link>
                  </Text>
                </div>
              </Form>
            </Card>
